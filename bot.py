...
def is_direct_web_request(text):
    ...
    markers = (
        ...
        "قیمت بیت کوین", "قیمت ارز", "قیمت بیت‌کوین", "قیمت خودرو",
        "نرخ دلار", "نرخ ارز",
        "آب و هوا", "وضعیت هوا", "هوای ",
    ...
    if "خبر" in value or "اخبار" in value:
        news_qualifiers = (
            ...
            "euronews", "یورونیوز", "یورو نیوز", "euro news",
        )
...
def switch_api_key():
    ...
    for guid in chat_keys:
        ...
        if chat_obj and model:
            try:
                new_session = model.start_chat(history=chat_obj.history)
                with _lock_hist:
